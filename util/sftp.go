...
// source: http://www.inanzzz.com/index.php/post/tjp9/golang-sftp-client-server-example-to-upload-and-download-files-over-ssh-connection-streaming
...
func (c *ClientWrapper) Close() {
	if c.sftpClient != nil {
		c.sftpClient.Close() // #nosec G104
	}
	if c.sshClient != nil {
		c.sshClient.Close() // #nosec G104
	}
}
